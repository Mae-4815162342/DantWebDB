...
public class SelectFindTest {
  ...
  public void FindIn() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"where\":{\"Age\":{\"in\":[80]}}}"), "titanic2", "findMany");
  ...
  public void FindGreaterEquals() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"where\":{\"Age\":{\"gte\":80}}}"), "titanic2", "findMany");
    String expected = "[{\"Embarked\":\"S\",\"Survived\":\"1\",\"Pclass\":\"1\",\"Ticket\":\"27042\",\"PassengerId\":\"631\",\"Parch\":\"0\",\"Cabin\":\"A23\",\"Sex\":\"male\",\"SibSp\":\"0\",\"Age\":\"80\",\"Name\":\"Barkworth, Mr. Algernon Henry Wilson\",\"Fare\":\"30\"}]";
    assertEquals(expected, actual);
  }
  ...
  public void FindGreater() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"where\":{\"Age\":{\"gt\":80}}}"), "titanic2", "findMany");
    String expected = "[]";
    assertEquals(expected, actual);
  }
  ...
  public void FindLeast() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"where\":{\"Age\":{\"lt\":0.0}}}"), "titanic2", "findMany");
    String expected = "[]";
    assertEquals(expected, actual);
  }
  @Test
  ...
  public void FindLeastEquals() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"where\":{\"Age\":{\"lt\":0.5}}}"), "titanic2", "findMany");
  ...
  public void FindStartsWith() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"select\":[\"PassengerId\"],\"where\":{\"Name\":{\"startsWith\":\"Thomas\"}}}"), "titanic2", "findMany");
    String expected = "[{\"PassengerId\":\"804\"}]";
    assertEquals(expected, actual);
  }
  @Test
  public void FindEndsWith() throws IOException {
    String actual = sendGetRequest(target, formatJSON(gson, "{\"select\":[\"PassengerId\"],\"where\":{\"Name\":{\"endsWith\":\"Alexander\"},\"PassengerId\":{\"gt\":800,\"lt\":815}}}"), "titanic2", "findMany");
    String expected = "[{\"PassengerId\":\"804\"}]";
    assertEquals(expected, actual);
  }
}